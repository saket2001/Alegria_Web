...
artistDetails={
    ...
    "p":"<p class='fs-7 sec-font text-black' style='text-align: justify;'>Priyank Sharma a multipotentialite, who has carved his name in the fields of acting, dancing and reality shows is all set to step his foot in Pillai’s Alegria as the judge for Freestyle Solo Dance. Priyank started his journey as a dancer in showbiz with Shaimak Davar’s dancing troupe. He rose to fame with his appearance on MTV Roadies to move on to being a finalist on MTV Splitsvilla followed by being a part of one of the biggest Indian Reality TV shows- BiggBoss. With his tough and charming personality, he became a huge craze among the youth in no time.</p><p class='fs-7 sec-font text-black' style='text-align: justify;'>From Reality TV shows he leapt into the Bollywood industry, making his debut with Aastha Gill and Badshah’s chart breaking song ‘BUZZ’. He then starred in many popular music videos like ‘Saara India’ and ‘Raanjhana’ and became a familiar face in the music video space. With the web series ‘Puncch Beat’, ‘The Holiday’ and ‘Mumbhai’ to his name, Priyank has made an unhindered spot for himself in the acting field.</p><p class='fs-7 sec-font text-black' style='text-align: justify;'></p>From being an ordinary boy in a middle-class family to being India’s heartthrob, Priyank took this voyage to be who he is today. Pillai College is all set to Welcome this multi-talented personality on 26th March to rock the Alegria stage with his moves and to guide and evaluate all the participants of Freestyle Solo. So buckle up and get ready for your hearts to be stolen by his charm and his groovy moves. Bring along your friends and have the time of your life in Alegria 2022.</p>"
},"a8":{
    "id":"a8",
    "name":"Vijaya Babar",
    "type":"Judge for Mono Acting",
    "img":"../static/images/homepage/vijaya_babar-poster.png",
    "p":"<p class='fs-7 sec-font text-black' style='text-align: justify;'>Vijaya Babar is an elegant and glamorous Marathi actress who has worked in a lot of Marathi dramas and plays. She is an alumnus of Pillai College and was a part of 'Spotlight', the theatre group of Pillai. Being a part of Pillai College, we are pleased to see our alumni reach new heights of success.  She never failed to impress everyone with her incredible acting skills during her college days. And now we are all set to welcome her as the judge for mono acting for Alegria 2022. </p><p class='fs-7 sec-font text-black' style='text-align: justify;'>Vijaya started her acting career with Marathi theatre. Further, she went on to star in the music video of 'Zindagi'. She entered the Marathi TV Industry with her show 'Shikast E Ishq' in which she played a pivotal role. Currently, she is playing the role of Chanda in the ongoing tv show 'Jai Jai Swami Samarth'. She was also the winner of Miss Mumbai. Her impeccable performance has left the audience in awe. She has become an inspiration for many of us.</p><p class='fs-7 sec-font text-black' style='text-align: justify;'>Vijaya is returning to her alma mater as a successful actress and we couldn't be more proud of her. She will be on campus to judge the mono acting performances and share her experiences in the acting field. With great alumni like Vijaya in our midst, it would be difficult to miss.</p>",
},"a9":{
    "id":"a9",
    "name":"Monika Starling",
    "type":"Judge for Fashion Show",
